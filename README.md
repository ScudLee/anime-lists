...
*  **offset**  - The number to add to each AniDb.net episode between the start and end values.
    ...
    For mapping specials other than anidb S-specials, the OP/ED speicals start from episode 101, the T-specials start from 201, the P-specials (parody/fandub) starts from 301 and the O-specials start from 401
